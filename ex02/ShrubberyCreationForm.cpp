...
/*   Updated: 2024/11/11 13:11:09 by crebelo-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ShrubberyCreationForm::ShrubberyCreationForm(const ShrubberyCreationForm& shrubberyCreationForm)
	: AForm(shrubberyCreationForm.getName(), shrubberyCreationForm.getSigned(),
			shrubberyCreationForm.getGradeExec(), shrubberyCreationForm.getGradeSign()), _target(shrubberyCreationForm.getTarget()) {
